	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			*/
			...
			VertexFormat(glm::vec3(0.5f, 0, 7.0f/8), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(0.5f, 1, 7.0f/16), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(0.5f, 0, 7.0f / 8), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(0.5f, 1, 7.0f / 16), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(0.5f, 0, 7.0f / 8), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(0.5f, 1, 7.0f / 16), glm::vec3(1, 1, 0))
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["box"], shaders["VertexNormal"], glm::vec3(0, 0.5f, 0), glm::vec3(0.75f));

	// render an object using colors from vertex
	RenderMesh(meshes["cube1"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(1));
